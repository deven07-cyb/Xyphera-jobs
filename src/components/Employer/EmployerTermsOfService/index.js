...
// import './EmployerTermsOfService.css';

// const EmployerTermsOfService = () => {
//   return (
//     <div  >
//       <EmployerHeader />
//       {/* <div></div>  background: linear-gradient(to bottom, #B0E1FF2E 17%, #ffffff 17%); */}

//       <div className="terms-of-service-container">
//         <div className="terms-header">
//           <h1>Terms of Service</h1>
//           <p>Updated March 10, 2025</p>
//         </div>
//         <div className="terms-content">
//           <div className="terms-section">
//             <h2>Introduction</h2>
//             <p>
//               Welcome to Job Board. By accessing or using our website located at "www.jobboard.com," you agree to comply with and be bound by these Terms of Service. If you do not agree to these terms, please do not use the Site.
//             </p>
//           </div>
...
//             <ul>
//               <li>Employers must ensure that job listings are accurate and not misleading.</li>
...
//             <p>
//               These Terms are governed by the laws of India. Any disputes will be resolved through binding arbitration in Bengaluru, India.
//             </p>
//           </div>
...
//             <p>
//               We may update these Terms from time to time. Continued use of the Site constitutes acceptance of the revised Terms.
//             </p>
//           </div>
...
//             <p>
//               For questions about these Terms, please contact us at <a href="mailto:support@jobboard.com">support@jobboard.com</a>.
//             </p>
//           </div>
//         </div>
//       </div>
...
// export default EmployerTermsOfService;  
...
const  EmployerTermsOfServicePage = () => {
  return (
...
export default EmployerTermsOfServicePage;