...
const ContactUs = () => {
  ...
  return (
    <div className="homepage-wrapper">
      <Header />
      <h1 style={{color:"#000000"}} className="contactus-title">Contact Us</h1>
      <div className="contactus-container contactus-containers-one">
        <div className="contactus-card">
          {/* Left: Contact Info */}
          <div style={{background:"#033E8A"}} className="contactus-info-panel">
          ...
          <form className="contactus-form" onSubmit={handleSubmit} autoComplete="off">
            ...
            <button style={{background:"#033E8A", width:"50%"}} type="submit" className="contactus-submit-btn">Send Message</button>
          </form>
        </div>
      </div>
      <Footer />
